...
bill = Comedian.create(name: "Bill Burr", age: 50, city: "Los Angeles", deceased?: "false", disgraced?: "false")
...
dave = Comedian.create(name: "Dave Chappelle", age: 45, city: "D.C.", deceased?: "false", disgraced?: "false")
...
nick = Comedian.create(name: "Nick Swardson", age: 41, city:"Minneapolis", deceased?: "false", disgraced?: "false")
...
louis = Comedian.create(name: "Louis C.K." , age: 51, city: "D.C.", deceased?: "false", disgraced?: "true")
...
patton = Comedian.create(name: "Patton Oswalt", age: 49, city: "Portsmouth", deceased?: "false", disgraced?: "false")
...
aziz = Comedian.create(name: "Aziz Ansari", age: 35, city: "Columbia", deceased?: "false", disgraced?: "uncertain")
...
hannibal = Comedian.create(name: "Hannibal Burress", age: 35, city: "Chicago", deceased?: "false", disgraced?: "false")
...
patrice = Comedian.create(name: "Patrice O'Neal", age: 41, city: "Englewood", deceased?: "true", disgraced?: "false")
